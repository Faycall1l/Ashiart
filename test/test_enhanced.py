...
class TestEnhancedAsciiArtGenerator(unittest.TestCase):
    ...
    def test_init_modes(self):
        ...
        self.assertEqual(
            braille_generator.chars, EnhancedAsciiArtGenerator.BRAILLE_CHARS
        )
    ...
    def test_html_generation(self):
        ...
        html = self.generator.generate_html(
            self.test_image_path, preserve_color=True, font_size=8
        )
    ...
    def test_convenience_functions(self):
        ...
        ascii_art = image_to_ascii(
            self.test_image_path, width=10, mode="dense", contrast=1.2
        )
        ...
        html = image_to_html_ascii(self.test_image_path, width=10, preserve_color=True)
    ...
    def test_dense_ramp_is_monotonic(self):
        ...
        self.assertTrue(
            all(cov[i] >= cov[i + 1] for i in range(len(cov) - 1)),
